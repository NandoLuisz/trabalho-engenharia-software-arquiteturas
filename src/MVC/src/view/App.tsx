...
import type { Task, Priority } from '../model/Task'
...
export function App() {
  ...
  useEffect(() => {
    controller.loadTasks(setTasks)
    controller.subscribeToEvents(setTasks)
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center">
      <div className="w-120 min-h-80 px-4 py-4">
        <h1 className="text-3xl font-semibold mb-2">Teu ToDo</h1>
        ...
        <div className="w-full flex flex-row items-end gap-3 mb-8">
          <div className="flex-1 flex flex-col gap-2">
            <input
              ...
              className="outline-none border-b-2 border-zinc-300 focus:border-zinc-500 px-1 py-2 w-full transition-colors"
            />
            ...
            >
              <input
                ...
                className="outline-none border-b-2 border-zinc-300 focus:border-zinc-500 px-1 py-2 flex-[2] w-full transition-colors"
              />
        ...
        {tasks.map(task => (
          ...
          >
            <div className="flex gap-2 items-start">
              <div onClick={() => handleToggleCompleted(task.id)}>
                {task.isCompleted ? (
